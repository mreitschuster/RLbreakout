...
baselinemodel=os.path.expanduser('~/models/breakout-v4/model/3.3_aimbot_training_mono_1dim_whiten_predict_4fs_0es')
...
#def prep_obs(obs):
#    image_obs=np.stack([obs[0,0,:,:],obs[0,0,:,:],obs[0,0,:,:]],axis=2) # we stack the 1-colour channel 3 times to have a grey image in rgb
#    return image_obs
