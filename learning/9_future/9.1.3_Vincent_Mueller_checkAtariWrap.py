...
name_model='9.1.3_Vincent_Mueller_checkAtariWrap'

import os
log_folder=os.path.expanduser('~/models/breakout-v4/log/'+folder_name+'/')
model_folder=os.path.expanduser('~/models/breakout-v4/model/'+folder_name+'/')
tensorboard_folder=os.path.expanduser('~/models/breakout-v4/tb_log/'+folder_name+'/')
...
model.learn(total_timesteps=int(5e6), callback=eval_callback, tb_log_name='Breakout-v4')
